...
namespace NuvemFiscal.Sdk.Api
{
    ...
    public partial class NfceApi : IDisposable, INfceApi
    {
        ...
        {
            NuvemFiscal.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarPdfNfceWithHttpInfo(id, logotipo, nomeFantasia, mensagemRodape, resumido, qrcodeLateral, largura, margem);
            return localVarResponse.Data;
        }
        ...
        /// <param name="margem">Define as margens do DANFE NFC-e (em milímetros).    Essa propriedade pode ser especificada usando um, dois, três ou quatro valores (separados por vírgulas). Cada valor deve ser um número entre &#x60;0&#x60; e &#x60;9&#x60;.  * Quando **um** valor é especificado, a mesma margem é aplicada para **todos os quatro lados**.  * Quando **dois** valores são especificados, a primeira margem é aplicada aos **lados esquerdo e direito**, e a segunda aos **lados superior e inferior**.  * Quando **três** valores são especificados, a primeira margem é aplicada ao **lado esquerdo**, a segunda aos **lados superior e inferior**, e a terceira ao **lado direito**.  * Quando **quatro** valores são especificados, as margens são aplicadas aos lados **esquerdo**, **superior**, **direito** e **inferior**, nesta ordem (sentido horário).    **Exemplos de uso**:  * &#x60;margem&#x3D;1&#x60;    - Margem esquerda: 1mm    - Margem superior: 1mm    - Margem direita: 1mm    - Margem inferior: 1mm  * &#x60;margem&#x3D;1,2&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 1mm    - Margem inferior: 2mm  * &#x60;margem&#x3D;1,2,3&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 3mm    - Margem inferior: 2mm  * &#x60;margem&#x3D;1,2,3,4&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 3mm    - Margem inferior: 4mm (optional, default to &quot;2&quot;)</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public NuvemFiscal.Sdk.Client.ApiResponse<FileParameter> BaixarPdfNfceWithHttpInfo(string id, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            ...
            if (margem != null)
            {
                localVarRequestOptions.QueryParameters.Add(NuvemFiscal.Sdk.Client.ClientUtils.ParameterToMultiMap("", "margem", margem));
            }
        ...
        {
            NuvemFiscal.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarPdfNfceWithHttpInfoAsync(id, logotipo, nomeFantasia, mensagemRodape, resumido, qrcodeLateral, largura, margem, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            NuvemFiscal.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarPreviaPdfNfceWithHttpInfo(body, logotipo, nomeFantasia, mensagemRodape, resumido, qrcodeLateral, largura, margem);
            return localVarResponse.Data;
        }
        ...
        /// <param name="margem">Define as margens do DANFE NFC-e (em milímetros).    Essa propriedade pode ser especificada usando um, dois, três ou quatro valores (separados por vírgulas). Cada valor deve ser um número entre &#x60;0&#x60; e &#x60;9&#x60;.  * Quando **um** valor é especificado, a mesma margem é aplicada para **todos os quatro lados**.  * Quando **dois** valores são especificados, a primeira margem é aplicada aos **lados esquerdo e direito**, e a segunda aos **lados superior e inferior**.  * Quando **três** valores são especificados, a primeira margem é aplicada ao **lado esquerdo**, a segunda aos **lados superior e inferior**, e a terceira ao **lado direito**.  * Quando **quatro** valores são especificados, as margens são aplicadas aos lados **esquerdo**, **superior**, **direito** e **inferior**, nesta ordem (sentido horário).    **Exemplos de uso**:  * &#x60;margem&#x3D;1&#x60;    - Margem esquerda: 1mm    - Margem superior: 1mm    - Margem direita: 1mm    - Margem inferior: 1mm  * &#x60;margem&#x3D;1,2&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 1mm    - Margem inferior: 2mm  * &#x60;margem&#x3D;1,2,3&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 3mm    - Margem inferior: 2mm  * &#x60;margem&#x3D;1,2,3,4&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 3mm    - Margem inferior: 4mm (optional, default to &quot;2&quot;)</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public NuvemFiscal.Sdk.Client.ApiResponse<FileParameter> BaixarPreviaPdfNfceWithHttpInfo(NfePedidoEmissao body, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string))
        {
        ...
        {
            NuvemFiscal.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarPreviaPdfNfceWithHttpInfoAsync(body, logotipo, nomeFantasia, mensagemRodape, resumido, qrcodeLateral, largura, margem, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<NuvemFiscal.Sdk.Client.ApiResponse<FileParameter>> BaixarPreviaPdfNfceWithHttpInfoAsync(NfePedidoEmissao body, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new NuvemFiscal.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling NfceApi->BaixarPreviaPdfNfce");
        ...
        {
            NuvemFiscal.Sdk.Client.ApiResponse<EmailStatusResponse> localVarResponse = EnviarEmailNfceWithHttpInfo(id, body);
            return localVarResponse.Data;
        }
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of EmailStatusResponse</returns>
        public NuvemFiscal.Sdk.Client.ApiResponse<EmailStatusResponse> EnviarEmailNfceWithHttpInfo(string id, DfePedidoEnvioEmail body = default(DfePedidoEnvioEmail))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new NuvemFiscal.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->EnviarEmailNfce");
        ...
        {
            NuvemFiscal.Sdk.Client.ApiResponse<EmailStatusResponse> localVarResponse = await EnviarEmailNfceWithHttpInfoAsync(id, body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EmailStatusResponse)</returns>
        public async System.Threading.Tasks.Task<NuvemFiscal.Sdk.Client.ApiResponse<EmailStatusResponse>> EnviarEmailNfceWithHttpInfoAsync(string id, DfePedidoEnvioEmail body = default(DfePedidoEnvioEmail), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new NuvemFiscal.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->EnviarEmailNfce");
