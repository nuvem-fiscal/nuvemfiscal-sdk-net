...
namespace NuvemFiscal.Sdk.Model
{
    ...
    public partial class TribMunicipal : IEquatable<TribMunicipal>, IValidatableObject
    {
        ...
        public TribMunicipal(int tribISSQN = default(int), string cPaisResult = default(string), BeneficioMunicipal bM = default(BeneficioMunicipal), ExigSuspensa exigSusp = default(ExigSuspensa), int tpImunidade = default(int), decimal pAliq = default(decimal), int tpRetISSQN = default(int))
        {
