...
namespace NuvemFiscal.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CtePedidoEmissaoLote")]
    public partial class CtePedidoEmissaoLote : IEquatable<CtePedidoEmissaoLote>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CtePedidoEmissaoLote" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CtePedidoEmissaoLote() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CtePedidoEmissaoLote" /> class.
        /// </summary>
        ...
        public CtePedidoEmissaoLote(List<CtePedidoEmissao> documentos = default(List<CtePedidoEmissao>), AmbienteEnum ambiente = default(AmbienteEnum), string referencia = default(string), string idLote = default(string))
        {
            // to ensure "documentos" is required (not null)
            if (documentos == null)
            {
                throw new ArgumentNullException("documentos is a required property for CtePedidoEmissaoLote and cannot be null");
            }
            ...
            if (idLote == null)
            {
                throw new ArgumentNullException("idLote is a required property for CtePedidoEmissaoLote and cannot be null");
            }
            this.id_lote = idLote;
        ...
        public List<CtePedidoEmissao> documentos { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CtePedidoEmissaoLote {\n");
        ...
        {
            return this.Equals(input as CtePedidoEmissaoLote);
        }

        /// <summary>
        /// Returns true if CtePedidoEmissaoLote instances are equal
        /// </summary>
        /// <param name="input">Instance of CtePedidoEmissaoLote to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CtePedidoEmissaoLote input)
        {
            if (input == null)
            {
                return false;
